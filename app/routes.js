...
module.exports = function(app, passport) {
    ...
    app.post('/commentaire/:id', isLoggedIn, function(req, res){
        if(req.user) {
            commentaire = req.body.commentaire;
            mail = req.user.username;
            let sql = `INSERT INTO commentaire(username,ActivitesId,commentaire) VALUES  ('${mail}','${req.params.id}', '${commentaire}')`;
